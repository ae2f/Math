...
typedef struct ae2f_MathInt {
  ...
  size_t vecbegpoint; /** @brief From which bit point is the start of the
                         integer. */
} ae2f_MathInt;
...
ae2f_MathIntFlip(ae2f_MathMemOutErr reterr, size_t count,
                 ...
                 ae2f_bMathMem __i_vec_unused, ae2f_bMathMem __o_vec_unused);
...
ae2f_MathIntAdd(ae2f_MathMemOutErr reterr, size_t count, const ae2f_MathInt *_a,
                ...
                ae2f_bMathMem __av_unused, ae2f_bMathMem __bv_unused,
...
ae2f_MathIntFill(ae2f_MathMemOutErr reterr, size_t count, ae2f_MathInt *a,
                 ae2f_oMathMem a_vec, bool mask, ae2f_bMathMem __a_vec);
...
ae2f_MathIntCmp(ae2f_MathMemOutErr errret, size_t count, const ae2f_MathInt *a,
                ...
                ae2f_CmpFunRet_t *out, ae2f_bMathMem _a_vec,
...
ae2f_MathIntMul(ae2f_MathMemOutErr reterr, size_t count, const ae2f_MathInt *a,
                ...
                ae2f_bMathMem a_vec_buf_unused, ae2f_bMathMem b_vec_buf_unused,
                ae2f_bMathMem b_vec_buf2_unused, ae2f_bMathMem o_vec_buf_unused,
                ae2f_bMathMem o_vec_buf2_unused,
                ae2f_bMathMem o_vec_buf3_unused);
